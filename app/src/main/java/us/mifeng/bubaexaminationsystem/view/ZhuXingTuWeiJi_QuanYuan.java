...
public class ZhuXingTuWeiJi_QuanYuan extends LinearLayout{
	...
	public ZhuXingTuWeiJi_QuanYuan(Context context,List<ZhouXueyuan> list) {
		super(context);
	...
	public void creatBarChat(List<ZhouXueyuan> list2,Context context){
		View v = LayoutInflater.from(context).inflate(R.layout.zhuxingtuview,ZhuXingTuWeiJi_QuanYuan.this, false);
